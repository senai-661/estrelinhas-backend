...
class Plano {
    ...
    public getDuracaoDias(): number { return this.duracaoDias; }
    public setDuracaoDias(duracao: number): void { this.duracaoDias = duracao; }
    ...
    // listarPlanos — só 1 tabela, continua direto
    ...
    // listarPlanosResumo — usa a VIEW (envolve plano + matricula)
    ...
    // listarPlano por ID — continua na tabela direta
